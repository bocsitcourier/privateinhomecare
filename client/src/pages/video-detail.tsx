        ...
        additionalSchemas={[
          {
            ...
            embedUrl: video.videoType === "youtube" ? video.embedUrl : undefined,
            contentUrl: video.videoType === "youtube" && video.embedUrl ? video.embedUrl.replace("/embed/", "/watch?v=") : video.videoUrl,
